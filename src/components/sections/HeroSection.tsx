  ...
  return (
    <section className="mb-[60px]">
      <div className="relative">
        <VideoPlayer videoUrl="/public/videos/desktop/UA_Theme_1_DT.mp4" controls={false} />
        <div className="absolute top-1/2 left-1/2 transform translate-x-5/12 -translate-y-1/2 space-y-8">
          <h1 className="text-[86px] leading-18 font-plak-condensed">
